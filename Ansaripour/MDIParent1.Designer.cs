...
namespace Ansaripour
{
    public partial class MDIParent1 : System.Windows.Forms.Form
    {
        ...
        this.Exits = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.MenuStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Services, this.Accounting, this.Repair, this.PayRoll, this.Warehouse, this.Assets, this.Payable, this.Collection_Document, this.Warranty_Document, this.Base_Information, this.Reports, this.View, this.Systems, this.Exits });
            ...
            //Services
            //
            this.Services.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Services_Sale_Managing, this.Services_Order_Add, this.Services_Seasonal_Buy_Sales, this.Services_Access });
            ...
            //
            this.Services_Seasonal_Buy_Sales.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Services_Seasonal_Buy, this.Services_Seasonal_Sale, this.Services_Seasonal_Contractor, this.Services_Seasonal_Employer, this.Services_Seasonal_Export, this.Services_Seasonal_Importation, this.Services_Seasonal_Contract_Work, this.Services_Seasonal_Rent, this.Services_Seasonal_Presell });
            ...
            //Services_Access
            //
            this.Services_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Services_Edit_Access, this.Services_Delete_Access });
            ...
            //Accounting
            //
            this.Accounting.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Accounting_Add, this.Accounting_View, this.Accounting_Mechanized, this.Accounting_Access });
        ...
        this.Accounting_View.Size = new System.Drawing.Size(233, 22);
            ...
            //Accounting_Access
            //
            this.Accounting_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Accounting_Edit_Access, this.Accounting_Delete_Access });
        this.Accounting_Access.Name = "Accounting_Access";
            ...
            //Repair
            //
            this.Repair.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Repair_Equipment, this.Repair_Cost, this.Repair_Access });
            ...
            //Repair_Access
            //
            this.Repair_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Repair_Edit_Access, this.Repair_Delete_Access });
        this.Repair_Access.Name = "Repair_Access";
            ...
            //PayRoll
            //
            this.PayRoll.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.PayRoll_Add, this.PayRoll_Computing, this.PayRoll_Computing_Difference, this.PayRoll_Access });
        this.PayRoll.Name = "PayRoll";
            ...
            //PayRoll_Add
            //
            this.PayRoll_Add.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.PayRoll_Attendance_Mechanized, this.PayRoll_Attendance_Manual, this.PayRoll_Base_Information, this.PayRoll_Deductions, this.PayRoll_Cure });
        ...
        this.PayRoll_Attendance_Manual.Text = "ورود و خــروج ( ثــــبــت دســـــتــی )";
            ...
            //PayRoll_Access
            //
            this.PayRoll_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.PayRoll_Edit_Access, this.PayRoll_Delete_Access });
        this.PayRoll_Access.Name = "PayRoll_Access";
            ...
            //Warehouse
            //
            this.Warehouse.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Request_Buy_Goods, this.Warehouse_Receipt_Remittance, this.Warehouse_Receipt_Remittance_Direct, this.Warehouse_Pricing, this.Warehouse_Handling, this.Warehouse_Access });
        this.Warehouse.Name = "Warehouse";
            ...
            //
            this.Warehouse_Request_Buy_Goods.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Request_Goods, this.Warehouse_Request_Buy, this.Warehouse_Request_Services });
        this.Warehouse_Request_Buy_Goods.Name = "Warehouse_Request_Buy_Goods";
            ...
            //
            this.Warehouse_Receipt_Remittance.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Receipt, this.Warehouse_Remittance });
        this.Warehouse_Receipt_Remittance.Name = "Warehouse_Receipt_Remittance";
            ...
            //Warehouse_Receipt
            //
            this.Warehouse_Receipt.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Receipt_Buy, this.Warehouse_Receipt_Return, this.Warehouse_Receipt_Loan, this.Warehouse_Receipt_Production, this.Warehouse_Opening });
        this.Warehouse_Receipt.Name = "Warehouse_Receipt";
            ...
            //
            this.Warehouse_Remittance.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Remittance_Use, this.Warehouse_Remittance_Sell });
        ...
        this.Warehouse_Receipt_Remittance_Direct.Size = new System.Drawing.Size(212, 22);
            ...
            //Warehouse_Handling
            //
            this.Warehouse_Handling.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Handling_Tag, this.Warehouse_First_Count, this.Warehouse_Second_Count, this.Warehouse_Final_Count });
            ...
            //Warehouse_Access
            //
            this.Warehouse_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warehouse_Edit_Access, this.Warehouse_Accounting_Access, this.Warehouse_Delete_Access });
        this.Warehouse_Access.Name = "Warehouse_Access";
            ...
            //Assets
            //
            this.Assets.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Assets_Fixed, this.Assets_Intangible, this.Assets_Consumable, this.Assets_Increase, this.Assets_Decrease, this.Assets_Movement, this.Assets_Dismiss, this.Assets_Revaluation, this.Assets_Calculate_Depreciation, this.Assets_Management, this.Assets_Access });
            ...
            //Assets_Access
            //
            this.Assets_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Assets_Edit_Access, this.Assets_Delete_Access });
        this.Assets_Access.Name = "Assets_Access";
            ...
            //Payable
            //
            this.Payable.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Payable_Payment, this.Payable_Deposits, this.Payable_Wage, this.Payable_Access });
            ...
            //Payable_Access
            //
            this.Payable_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Payable_Edit_Access, this.Payable_Delete_Access });
        this.Payable_Access.Name = "Payable_Access";
            ...
            //Collection_Document
            //
            this.Collection_Document.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Collection_Document_Add, this.Collection_Document_Assignment, this.Collection_Document_Notice, this.Collection_Document_Back, this.Collection_Document_Extradition, this.Collection_Document_Reform, this.Collection_Document_Access });
            //this.Collection_Document.ImageTransparentColor = new System.Drawing.SystemColors.ActiveBorder;
            ...
            //
            //this.Collection_Document_Add.ImageTransparentColor = new System.Drawing.Color.Black;
            ...
            //
            //this.Collection_Document_Assignment.ImageTransparentColor =new System.Drawing.Color.Black;
            ...
            //
            //this.Collection_Document_Notice.ImageTransparentColor =new System.Drawing.Color.Black;
            ...
            //
            //this.Collection_Document_Extradition.ImageTransparentColor =new System.Drawing.Color.Black;
            ...
            //
            this.Collection_Document_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Collection_Document_Edit_Access, this.Collection_Document_Delete_Access });
        ...
        this.Collection_Document_Access.Visible = false;
            ...
            //Warranty_Document
            //
            this.Warranty_Document.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warranty_Document_Add, this.Warranty_Document_Extended, this.Warranty_Document_Refund, this.Warranty_Document_Reform, this.Warranty_Document_Access });
            ...
            //
            this.Warranty_Document_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Warranty_Document_Edit_Access, this.Warranty_Document_Delete_Access });
        this.Warranty_Document_Access.Name = "Warranty_Document_Access";
            ...
            //Base_Information
            //
            this.Base_Information.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Services, this.Base_Information_Accounting, this.Base_Information_Repair, this.Base_Information_PayRoll, this.Base_Information_Warehouse, this.Base_Information_Assets, this.Base_Information_Document });
        this.Base_Information.Name = "Base_Information";
            ...
            //
            this.Base_Information_Services.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Services_Seasonal_Buy_Sales, this.Base_Information_Services_Order, this.Base_Information_Services_Access });
            ...
            //
            this.Base_Information_Services_Seasonal_Buy_Sales.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Seasonal_Product_Type });
            ...
            //
            this.Base_Information_Services_Order.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Services_Order_Customer, this.Base_Information_Services_Order_In_Services, this.Base_Information_Services_Order_Out_Services, this.Base_Information_Services_Order_Opertor, this.Base_Information_Services_Order_Rate });
        ...
        this.Base_Information_Services_Order_Rate.Text = "مــــیــــزان هــــمــــکــــاری";
            ...
            //
            this.Base_Information_Services_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Services_Edit_Access, this.Base_Information_Services_Delete_Access });
        ...
        this.Base_Information_Services_Delete_Access.Visible = false;
            ...
            //
            this.Base_Information_Accounting.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Accounting_Account_Tree, this.Base_Information_Accounting_Detailed_Tree, this.Base_Information_Accounting_Access });
        ...
        this.Base_Information_Accounting_Account_Tree.Size = new System.Drawing.Size(160, 22);
            ...
            //
            this.Base_Information_Accounting_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Accounting_Edit_Access, this.Base_Information_Accounting_Delete_Access });
            ...
            //
            this.Base_Information_Repair.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Repair_Seating, this.Base_Information_Repair_Energy, this.Base_Information_Repair_Phase, this.Base_Information_Repair_Kind_Stream, this.Base_Information_Repair_Kind_Fuse, this.Base_Information_Repair_Connector_Type, this.Base_Information_Repair_Stop_Defect, this.Base_Information_Repair_Access });
        ...
        this.Base_Information_Repair_Connector_Type.Visible = false;
            ...
            //
            this.Base_Information_Repair_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Repair_Edit_Access, this.Base_Information_Repair_Delete_Access });
        ...
        this.Base_Information_Repair_Delete_Access.Text = "دسترسی به حـــــذف اطلاعات پایه تعمیر و نگهداری";
            ...
            //
            this.Base_Information_PayRoll.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_PayRoll_Personal, this.Base_Information_PayRoll_Employment, this.Base_Information_PayRoll_Deductions_Legal, this.Base_Information_PayRoll_Deductions_Diffrent, this.Base_Information_PayRoll_Family, this.Base_Information_PayRoll_Calandar, this.Base_Information_PayRoll_Access });
        ...
        //
            ...
            //
            this.Base_Information_PayRoll_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_PayRoll_Edit_Access, this.Base_Information_PayRoll_Delete_Access });
        ...
        this.Base_Information_PayRoll_Access.Size = new System.Drawing.Size(190, 22);
            ...
            //
            this.Base_Information_Warehouse.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Warehouse_Units, this.Base_Information_Warehouse_Sources, this.Base_Information_Warehouse_Unit_Goods, this.Base_Information_Warehouse_Grouping_Goods, this.Base_Information_Warehouse_Collection_Goods, this.Base_Information_Warehouse_Access });
        ...
        this.Base_Information_Warehouse_Sources.Text = "طرف حساب و منابع تهیه وتوزیع";
            ...
            //
            this.Base_Information_Warehouse_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Warehouse_Edit_Access, this.Base_Information_Warehouse_Delete_Access });
        this.Base_Information_Warehouse_Access.Name = "Base_Information_Warehouse_Access";
            ...
            //
            this.Base_Information_Assets.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Assets_Depreciation_Rate, this.Base_Information_Assets_Plan_project, this.Base_Information_Assets_City, this.Base_Information_Assets_Personnel, this.Base_Information_Assets_Cost_Code, this.Base_Information_Assets_Date, this.Base_Information_Assets_Access });
        ...
        this.Base_Information_Assets_Cost_Code.Size = new System.Drawing.Size(201, 22);
            ...
            //
            this.Base_Information_Assets_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Assets_Edit_Access, this.Base_Information_Assets_Delete_Access });
        this.Base_Information_Assets_Access.Name = "Base_Information_Assets_Access";
            ...
            //
            this.Base_Information_Document.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Document_Bank, this.Base_Information_Document_Recovery_Classification, this.Base_Information_Warranty_Document_Classification, this.Base_Information_Document_Customer, this.Base_Information_Document_Area, this.Base_Information_Document_Access });
        ...
        this.Base_Information_Document_Customer.Text = "ثبت اطلاعـــــات مـــشتـــرک";
            ...
            //
            this.Base_Information_Document_Access.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Base_Information_Document_Edit_Access, this.Base_Information_Document_Delete_Access });
        this.Base_Information_Document_Access.Name = "Base_Information_Document_Access";
            ...
            //Reports
            //
            this.Reports.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Services, this.Report_Accounting, this.Report_Repair, this.Report_PayRoll, this.Report_Warehouse, this.Report_Estate, this.Report_Payable, this.Report_Collection_Document, this.Report_Warranty_Document });
        this.Reports.Name = "Reports";
            ...
            //Report_Accounting
            //
            this.Report_Accounting.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Accounting_Note_Book, this.Report_Accounting_Align, this.Report_Accounting_Reports, this.Report_Accounting_Analysis });
        this.Report_Accounting.Name = "Report_Accounting";
            ...
            //
            this.Report_Accounting_Note_Book.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Accounting_Account_Note_Book, this.Report_Accounting_Details_Note_One_Book, this.Report_Accounting_Details_Note_Two_Book, this.Report_Accounting_Details_Note_Three_Book, this.Report_Accounting_Details_Note_Four_Book, this.Report_Accounting_Details_Note_Five_Book });
        ...
        //
            ...
            //
            this.Report_Accounting_Align.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Accounting_Four_Column_Align, this.Report_Accounting_Details_Four_Column_Align, this.Report_Accounting_Eight_Column_Align, this.Report_Accounting_Details_Eight_Column_Align });
        ...
        this.Report_Accounting_Eight_Column_Align.Visible = false;
            ...
            //
            this.Report_Accounting_Reports.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Accounting_Details });
            ...
            //Report_Warehouse
            //
            this.Report_Warehouse.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Warehouse_Number, this.Report_Warehouse_Cardx, this.Report_Warehouse_Turnover, this.Report_Warehouse_Inventory, this.Report_Warehouse_Accounting, this.Report_Warehouse_Accounting_Cardx, this.Report_Warehouse_Accounting_Turnover, this.Report_Warehouse_Accounting_Inventory, this.Report_Warehouse_Handling, this.Report_Warehouse_Handling_One_Counts, this.Report_Warehouse_Handling_Two_Counts, this.Report_Warehouse_Handling_Third_Counts });
        ...
        this.Report_Warehouse_Handling_Two_Counts.Visible = false;
            ...
            //Report_Estate
            //
            this.Report_Estate.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Estate_Responsible, this.Report_Estate_Consumable_Delivering, this.Report_Estate_Delivering, this.Report_Consumable_Delivering, this.Report_Estate_Accountants, this.Report_Estate_Facial, this.Report_Estate_Original_Code, this.Report_Estate_Cost_Code, this.Report_Estate_Cost_Original, this.Report_Estate_Original_Cost, this.Report_Estate_Original_Cost_City, this.Report_Estate_Decrease, this.Report_Estate_Dismiss, this.Report_Estate_Document_Cost, this.Report_Estate_Document_Original, this.Report_Estate_Document_Dismiss });
        ...
        this.Report_Estate_Consumable_Delivering.Visible = false;
            ...
            //Report_Payable
            //
            this.Report_Payable.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Payable_Turnover, this.Report_Payable_Checked_Out, this.Report_Payable_Deposits, this.Report_Payable_Wage });
            ...
            //
            this.Report_Collection_Document.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Collection_Document_Add, this.Report_Collection_Document_Due_Date, this.Report_Collection_Document_Assignment, this.Report_Collection_Document_Notice, this.Report_Collection_Document_Back, this.Report_Collection_Document_Refund_Date, this.Report_Collection_Document_Receipt });
            ...
            //
            this.Report_Warranty_Document.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Report_Warranty_Document_No_Date, this.Report_Warranty_Document_Extended_Date, this.Report_Warranty_Document_Refund_Date, this.Report_Warranty_Document_Due_Date, this.Report_Warranty_Document_Date });
            ...
            //View
            //
            this.View.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] { this.View_Menu_Toolbox, this.View_Menu_Subtitle, this.View_Menu_Help, this.View_Menu_Log });
            this.View.Name = "View";
        ...
        this.View_Menu_Toolbox.Visible = false;
            ...
            this.StatusStrip.Items.AddRange(new System.Windows.Forms.ToolStripItem[] { this.Today_Date, this.ID, this.I_N, this.Report, this.N_Admin, this.N_Id_Area, this.N_Company_Area, this.N_Department_Area, this.N_Fiscal_Year_Area, this.Description, this.Information });
        ...
        this.Report.Size = new System.Drawing.Size(42, 17);
            ...
            this.SplitContainer1.Anchor = (System.Windows.Forms.AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Bottom) | AnchorStyles.Left) | AnchorStyles.Right);
        ...
        this.SplitContainer1.Panel2.Controls.Add(this.tvData);
            ...
            //this.Label3.Font =  Font("Tahoma", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(178)));
            ...
            //this.Label5.Font = new System.Drawing.Font("Tahoma", 18F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte));
            ...
            //this.Label3.Font = new System.Drawing.Font("Tahoma", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte));
            ...
            //this.Label_Collection.Font = new System.Drawing.Font("Microsoft Sans Serif", 18, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte));
            ...
            this.Label_Collection.Size = new System.Drawing.Size(27, 29);
            ...
            //this.Label1.Font = new System.Drawing.Font("Microsoft Sans Serif", 18, FontStyle.Bold, System.Drawing.GraphicsUnit.Point, (byte)0);
            ...
            //this.Label_Warranty.Font = new System.Drawing.Font("Microsoft Sans Serif", 18, FontStyle.Bold, System.Drawing.GraphicsUnit.Point, (byte)0);
            ...
            this.Label_Warranty.Size = new System.Drawing.Size(27, 29);
        ...
        //this.tvData.Font = new System.Drawing.Font("Tahoma", 15.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(178, Byte))
        this.tvData.Location = new System.Drawing.Point(0, 0);
            ...
            //this.Font =new System.Drawing.Font("Microsoft Sans Serif", 8.25!);
        ...
        private System.Windows.Forms.ToolStripMenuItem System_Activation_Menu;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Extradition;

        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Back;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Add;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Assignment;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Notice;
        private System.Windows.Forms.ToolStripMenuItem Base_Information;
        private System.Windows.Forms.ToolStripMenuItem View;
        private System.Windows.Forms.ToolStripMenuItem View_Menu_Toolbox;
        private System.Windows.Forms.ToolStripMenuItem View_Menu_Subtitle;
        private System.Windows.Forms.ToolStripMenuItem Reports;
        private System.Windows.Forms.StatusStrip StatusStrip;
        private System.Windows.Forms.ToolStripStatusLabel Today_Date;
        private System.Windows.Forms.ToolStripMenuItem Exits;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Reform;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Add;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Refund;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Reform;
        private System.Windows.Forms.ToolStripMenuItem Payable;
        private System.Windows.Forms.ToolStripMenuItem Payable_Payment;
        private System.Windows.Forms.ToolStripMenuItem Payable_Deposits;
        private System.Windows.Forms.ToolStripMenuItem Payable_Wage;
        private System.Windows.Forms.ToolStripStatusLabel ID;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets;
        private System.Windows.Forms.ToolStripStatusLabel I_N;
        private System.Windows.Forms.ToolStripMenuItem Accounting;
        private System.Windows.Forms.ToolStripMenuItem Assets;
        private System.Windows.Forms.ToolStripMenuItem Assets_Fixed;
        private System.Windows.Forms.ToolStripMenuItem Assets_Increase;
        private System.Windows.Forms.ToolStripMenuItem Assets_Decrease;
        private System.Windows.Forms.ToolStripMenuItem Assets_Movement;
        private System.Windows.Forms.ToolStripMenuItem Assets_Dismiss;
        private System.Windows.Forms.ToolStripMenuItem Assets_Revaluation;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Depreciation_Rate;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_City;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Personnel;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Cost_Code;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Recovery_Classification;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warranty_Document_Classification;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Customer;
        private System.Windows.Forms.ToolStripMenuItem Accounting_Add;
        private System.Windows.Forms.ToolStripMenuItem Accounting_View;
        private System.Windows.Forms.ToolStripMenuItem Accounting_Mechanized;
        private System.Windows.Forms.ToolStripMenuItem Assets_Calculate_Depreciation;
        private System.Windows.Forms.ToolStripMenuItem Assets_Consumable;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting_Account_Tree;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting_Detailed_Tree;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Date;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Extended;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Units;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Sources;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Unit_Goods;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Grouping_Goods;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Collection_Goods;
        private System.Windows.Forms.ToolStripMenuItem Repair;
        private System.Windows.Forms.ToolStripMenuItem Warehouse;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Request_Buy_Goods;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Remittance;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Remittance_Direct;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Pricing;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Handling;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Handling_Tag;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_First_Count;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Second_Count;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Final_Count;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Request_Goods;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Request_Buy;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Request_Services;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Remittance;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Personal;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Employment;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Deductions_Legal;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Deductions_Diffrent;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Family;
        private System.Windows.Forms.ToolStripMenuItem PayRoll;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Add;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Attendance_Mechanized;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Attendance_Manual;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Base_Information;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Deductions;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Computing;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Computing_Difference;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Calandar;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Cure;
        private System.Windows.Forms.ToolStripStatusLabel Report;
        private System.Windows.Forms.ToolStripMenuItem System_Area_Menu;
        private System.Windows.Forms.ToolStripMenuItem System_Chang_User_Menu;
        private System.Windows.Forms.ToolStripStatusLabel N_Admin;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Plan_project;
        private System.Windows.Forms.ToolStripMenuItem Repair_Equipment;
        private System.Windows.Forms.ToolStripMenuItem Repair_Cost;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Seating;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Energy;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Phase;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Kind_Stream;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Kind_Fuse;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Connector_Type;
        private System.Windows.Forms.ToolStripMenuItem View_Menu_Help;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Stop_Defect;
        private System.Windows.Forms.ToolStripMenuItem Assets_Management;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Buy;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Return;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Loan;
        private System.Windows.Forms.ToolStripMenuItem View_Menu_Log;
        private System.Windows.Forms.ToolStripMenuItem Assets_Intangible;
        private System.Windows.Forms.ToolStripStatusLabel N_Fiscal_Year_Area;
        private System.Windows.Forms.ToolStripStatusLabel N_Company_Area;
        private System.Windows.Forms.ToolStripStatusLabel N_Department_Area;
        private System.Windows.Forms.ToolStripStatusLabel N_Id_Area;
        private System.Windows.Forms.ToolStripStatusLabel Description;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Area;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services;
        private System.Windows.Forms.ToolStripMenuItem Services_Sale_Managing;
        private System.Windows.Forms.ToolStripMenuItem Services_Order_Add;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Buy_Sales;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Buy;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Sale;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Contractor;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Employer;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Export;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Importation;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Contract_Work;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Rent;
        private System.Windows.Forms.ToolStripMenuItem Services_Seasonal_Presell;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Seasonal_Buy_Sales;
        private System.Windows.Forms.ToolStripMenuItem Base_Seasonal_Product_Type;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order_Customer;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order_In_Services;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order_Opertor;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order_Out_Services;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Order_Rate;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Receipt_Production;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Remittance_Use;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Remittance_Sell;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Access;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Collection_Document_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Access;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Warranty_Document_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Payable_Access;
        private System.Windows.Forms.ToolStripMenuItem Payable_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Payable_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Assets_Access;
        private System.Windows.Forms.ToolStripMenuItem Assets_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Assets_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Access;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Accounting_Access;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Accounting_Access;
        private System.Windows.Forms.ToolStripMenuItem Accounting_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Accounting_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Services_Access;
        private System.Windows.Forms.ToolStripMenuItem Services_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Services_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Repair_Access;
        private System.Windows.Forms.ToolStripMenuItem Repair_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Repair_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Access;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem PayRoll_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Accounting_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_PayRoll_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Assets_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Warehouse_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Repair_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Edit_Access;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Services_Delete_Access;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse;
        private System.Windows.Forms.ToolStripMenuItem Report_Payable;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document_No_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document_Extended_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document_Refund_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document_Due_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Warranty_Document_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Add;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Due_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Assignment;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Notice;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Back;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Refund_Date;
        private System.Windows.Forms.ToolStripMenuItem Report_Collection_Document_Receipt;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Responsible;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Consumable_Delivering;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Delivering;
        private System.Windows.Forms.ToolStripMenuItem Report_Consumable_Delivering;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Accountants;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Facial;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Original_Code;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Cost_Code;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Cost_Original;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Original_Cost;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Original_Cost_City;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Decrease;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Dismiss;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Document_Cost;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Document_Original;
        private System.Windows.Forms.ToolStripMenuItem Report_Estate_Document_Dismiss;
        private System.Windows.Forms.ToolStripMenuItem Report_Payable_Turnover;
        private System.Windows.Forms.ToolStripMenuItem Report_Payable_Checked_Out;
        private System.Windows.Forms.ToolStripMenuItem Report_Payable_Deposits;
        private System.Windows.Forms.ToolStripMenuItem Report_Payable_Wage;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Number;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Cardx;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Turnover;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Inventory;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Accounting;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Accounting_Cardx;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Accounting_Turnover;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Accounting_Inventory;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Handling;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Handling_One_Counts;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Handling_Two_Counts;
        private System.Windows.Forms.ToolStripMenuItem Report_Warehouse_Handling_Third_Counts;
        private System.Windows.Forms.ToolStripStatusLabel Information;
        private System.Windows.Forms.ToolStripMenuItem Report_Services;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting;
        private System.Windows.Forms.ToolStripMenuItem Report_Repair;
        private System.Windows.Forms.ToolStripMenuItem Report_PayRoll;
        private System.Windows.Forms.ToolStripMenuItem Warehouse_Opening;
        private System.Windows.Forms.ToolStripMenuItem Base_Information_Document_Bank;
        private System.Windows.Forms.ToolStripMenuItem System_sms;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Note_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Align;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Four_Column_Align;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Reports;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Analysis;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Four_Column_Align;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Eight_Column_Align;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Eight_Column_Align;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Account_Note_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Note_One_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Note_Two_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Note_Three_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Note_Four_Book;
        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details_Note_Five_Book;
        private System.Windows.Forms.ToolStripMenuItem System;

        private System.Windows.Forms.ToolStripMenuItem Report_Accounting_Details;
        ...
        private System.Windows.Forms.ToolStripItem Systems;
        private System.Windows.Forms.ToolStripMenuItem System_User_Menu;
    }
}